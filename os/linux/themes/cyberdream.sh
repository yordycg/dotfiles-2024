# Cyberdream Palette
export THEME_NAME="cyberdream"
export COLOR_BG="#16181a"
export COLOR_FG="#ffffff"
export COLOR_ACCENT="#5eff6c"
export COLOR_BORDER="#3c4048"
...
export HARLEQUIN_THEME="one-dark"
